...
import com.education.shengnongcollege.play.TXPlayerAuthParam;
import com.education.shengnongcollege.play.net.TXCVodPlayerNetApi;
import com.education.shengnongcollege.play.net.TXCVodPlayerNetListener;
import com.education.shengnongcollege.play.net.TXPlayInfoResponse;
import com.education.shengnongcollege.play.wkvideoplayer.model.Video;
import com.education.shengnongcollege.play.wkvideoplayer.model.VideoUrl;
...
public class SuperVideoPlayer extends RelativeLayout {
    ...
    private class MediaControl implements MediaController.MediaControlImpl, MediaToolbar.MediaToolbarImpl, ResolutionPanel.ResolutionChangeImpl, MoreSettingPanel.MoreSettingChangeImpl {
        ...
        public void onPageTurn() {
            ...
            if(mCurrPageType == MediaController.PageType.EXPAND){
                mMediaToolbar.setOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
            }else{
                mMediaToolbar.setOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
            }
        }
    ...
    private void stopListen() {
        ...
        MyApp.getInstence().unregisterActivityLifecycleCallbacks(mPhoneListener);
    }
    ...
    private void startListen() {
        ...
        MyApp.getInstence().registerActivityLifecycleCallbacks(mPhoneListener);
    }
