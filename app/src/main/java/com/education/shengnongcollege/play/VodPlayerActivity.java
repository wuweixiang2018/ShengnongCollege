package com.education.shengnongcollege.play;
...
import com.education.shengnongcollege.play.wkvideoplayer.view.VodRspData;
import com.education.shengnongcollege.videopublish.server.GetVideoInfoListListener;
import com.education.shengnongcollege.videopublish.server.VideoDataMgr;
import com.education.shengnongcollege.videopublish.server.VideoInfo;
...
public class VodPlayerActivity extends BaseTopActivity implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    //课程介绍tab
    private TextView introduceTabTV;
    private LinearLayout underlineOne;
    //课程介绍内容
    ...
    private LinearLayout underlineTwo;
    //课程评论
...
//        mBtnScan.setOnClickListener(this);
        ...
        introduceLL.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                introduceTV.setVisibility(View.VISIBLE);
                introduceTabTV.setTextColor(getResources().getColor(R.color.orange));
                underlineOne.setVisibility(View.VISIBLE);

                mSwipeRefreshLayout.setVisibility(View.GONE);
                commentTabTV.setTextColor(getResources().getColor(R.color.black));
        ...
        commentLL.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                introduceTabTV.setTextColor(getResources().getColor(R.color.black));
        ...
        underlineTwo = findViewById(R.id.underline_2);
