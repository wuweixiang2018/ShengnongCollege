...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	public void setItemStyle(View view, boolean check, int position){
		try {
			...
			TextView unber = view.findViewById(R.id.textView_unber);
			tv.setText(mItems.get(position));
			if (check) {
				tv.setTextColor(getResources().getColor(R.color.colorRed));
				unber.setBackgroundColor(getResources().getColor(R.color.colorRed));
			} else {
				tv.setTextColor(getResources().getColor(R.color.white));
				unber.setBackgroundColor(getResources().getColor(R.color.white));
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
