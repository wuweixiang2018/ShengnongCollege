...
//        });
    ...
    public void jionGroup(final String groupId, final IMMessageMgr.Callback callback) {
        mIMMessageMgr.jionGroup(groupId, callback);
    }
    ...
    public void login(final LoginCallback callback) {
        ...
        super.login(new IMMessageMgr.Callback() {
            @Override
...
////        jionGroup(groupId, new JoinGroupCallback() {
////            @Override
